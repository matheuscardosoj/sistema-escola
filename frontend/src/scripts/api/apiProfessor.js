class ApiProfessor {
    ...
    async pegarProfessoresFiltrados(filtro, mostrarInativas) {
    ...
    async criarProfessor(nome, cpf, endereco, telefone) {
    ...
    async alterarProfessor(idProfessor, nome, cpf, endereco, telefone) {
